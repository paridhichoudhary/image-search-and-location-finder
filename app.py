...
def index():
    ...
    for i,rec in enumerate(matches_sample):
        ...
        # copyfile(r"C:\Users\bg532fh\Documents\Personal\Kaggle\Vacation Destination\intel-image-classification\app_iceland\\" + location, r"./static/images/pic_" + str(i) + ".png")
...
def findLocation():
    if request.method == 'POST':
        ...
        for i, city in enumerate(pd.Series(results)):
            ...
            blob.download_to_filename(r"static/images/result_" + selected_pic.split(".")[0]+"_"+str(i) + ".png")
            # copyfile(r"C:\Users\bg532fh\Documents\Personal\Kaggle\Vacation Destination\intel-image-classification\Dataset"+image_path + location, r"static/images/result_" + selected_pic.split(".")[0]+"_"+str(i) + ".png")
        return "|".join(results)
    return None
